# Train loss: 0.010198
# Validation loss: 0.003036
# matthews_corrcoef: 0.9771
# accuracy_score: 0.9992
# precision_score: 0.9682
# recall_score: 0.9870
# f1_score: 0.9775
...
class HybridModel(nn.Module):
    def __init__(self, n_classes, patch_size, embedding_size):
        ...
        self.conv1 = nn.Conv1d(in_channels=embedding_size, out_channels=128, kernel_size=5, padding=2)   # out_channels=64 - mcc does not exceed 0.9
